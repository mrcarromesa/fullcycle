...
type Job struct {
	...
	Video            *Video    `json:"video" valid:"-"` // O * é um ponteiro para um objeto no caso o objeto Video ou seja aponta para o mesmo local da memória do objeto Video
...
func (job *Job) Validate() error {
	_, err := validator.ValidateStruct(job)
